...
fixed            | `false`                      | Boolean | Whether to set CSS position absolute or fixed of lightBox. open             | `{"sucess":function(){},"event":"click","anim":{"className":""} }` | Object  | success: Open callback. event: Event on trigger which opens lightBox. anim: classname to add animation while open.
