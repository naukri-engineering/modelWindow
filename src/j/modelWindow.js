...
//			anim : {className:'',duration:0}
	...
	var init_openclose_Properties = function(){
		...
		this.options.trigger.on(this.options.open.event+'.'+this.pluginName,this.options.open.selector,function(){_this.open();})
	...
	/** To be overrited */
	var resize = function(){
		model.lt.cont.css({width:'auto',height:'auto'})
